...
from dags.data_ingestion.utils import upload_file_to_s3, SCRAPED_RESOURCES_PATH, BASE_RESOURCES_PATH
...
def main():
    try:
        ...
        logger.error(f"Problematic JSON content: {problematic_content[:500]}...")  # Log the first 500 characters
