# dags/cfa_publications_pipeline.py
...
from pdf_img_downloader import extract_article_details_and_files
from upload_img_pdf import update_article_links
from article import insert_articles_from_json
...
# Local directories
IMAGE_DIRECTORY = "/opt/airflow/dags/images"
PDF_DIRECTORY = "/opt/airflow/dags/pdfs"
...
def download_and_save_articles(**kwargs):
    ...
    output_file = '/opt/airflow/dags/articles_data.json'
...
def upload_to_s3_and_update_links(**kwargs):
    ...
    input_file = '/opt/airflow/dags/articles_data.json'
    ...
    output_file = '/opt/airflow/dags/updated_articles_data.json'
    with open(output_file, 'w', encoding='utf-8') as f:
...
def insert_to_snowflake(**kwargs):
    json_file_path = '/opt/airflow/dags/updated_articles_data.json'
