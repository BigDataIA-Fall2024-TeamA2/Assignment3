...
async def get_article(article_id: str, token: str = Depends(security_scheme)) -> ArticleResponse:
...
async def generate_summary(article_id: str, token: str = Depends(security_scheme)) -> ArticleSummaryResponse:
