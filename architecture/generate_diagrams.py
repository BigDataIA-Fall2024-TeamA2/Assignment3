...
def generate_assignment3_architecture():
    with Diagram("Assignment 3 Architecture", direction="LR", filename="diagrams/assignment3_architecture", outformat="png", show=False) as dia:
        ...
        with Cluster("Backend Processing"):
            ...
            fastapi_app >> [nvidia_summary, nvidia_rag]  # FastAPI backend interacts with NVIDIA services
        ...
        with Cluster("Client-Facing UI"):
            ...
            streamlit_ui >> [doc_selection_page, summary_page, qa_interface_page, report_gen_page]  # Connect UI pages to main Streamlit interface
